...
public class ChatActionCell extends BaseCell implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public ChatActionCell(Context context, boolean canDrawInParent, Theme.ResourcesProvider resourcesProvider) {
        ...
        starGiftLayout = new StarGiftUniqueActionLayout(currentAccount, getContext(), resourcesProvider);
    ...
    private void openStarsGiftTransaction() {
        ...
        // Tony Chat: Stars removed
        /* if (currentMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionGiftStars) {
            StarsIntroActivity.showTransactionSheet(getContext(), currentAccount, currentMessageObject.messageOwner.date, currentMessageObject.messageOwner.from_id, currentMessageObject.messageOwner.peer_id, (TLRPC.TL_messageActionGiftStars) currentMessageObject.messageOwner.action, null);
        } else if (currentMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionPrizeStars) {
            StarsIntroActivity.showTransactionSheet(getContext(), currentAccount, currentMessageObject.messageOwner.date, currentMessageObject.messageOwner.from_id, currentMessageObject.messageOwner.peer_id, (TLRPC.TL_messageActionPrizeStars) currentMessageObject.messageOwner.action, null);
        } else if (currentMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionGiftTon) {
            StarsIntroActivity.showTransactionSheet(getContext(), currentAccount, currentMessageObject.messageOwner.date, currentMessageObject.messageOwner.from_id, currentMessageObject.messageOwner.peer_id, (TLRPC.TL_messageActionGiftTon) currentMessageObject.messageOwner.action, null);
...
//            StarsIntroActivity.showActionGiftSheet(getContext(), currentAccount, currentMessageObject.getDialogId(), currentMessageObject.isOutOwner(), currentMessageObject.messageOwner.date, currentMessageObject.getId(), action, themeDelegate);
    ...
    private void openStarsNeedSheet() {
        // TONY_CHAT: Stars feature removed
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (starGiftLayout.has()) {
            // TONY_CHAT: repost field removed
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (starGiftLayout.has()) {
            canvas.save();
            // TONY_CHAT: repost field removed
            canvas.translate(starGiftLayoutX = (getWidth() - starGiftLayout.getWidth()) / 2.0f, starGiftLayoutY = textY + textHeight + dp(4 + 6 + 6));
    ...
    public void drawBackground(Canvas canvas, boolean fromParent) {
        ...
        if (starGiftLayout.has()) {
            ...
            float y = textY + textHeight + dp(12); // TONY_CHAT: repost removed
    ...
    public void drawOutboundsContent(Canvas canvas) {
        ...
        if (starGiftLayout.has()) {
            canvas.save();
            canvas.translate((getWidth() - starGiftLayout.getWidth()) / 2.0f, textY + textHeight + dp(4 + 6 + 6)); // TONY_CHAT: repost removed
            starGiftLayout.drawOutbounds(canvas);
            canvas.restore();
        }
        canvas.restore();
