...
*/
            ...
            for (int a = 0, N = dialogFilters.size(); a < N + 2; a++) {
                ...
                if (a < N) {
                    ...
                    flags = filter.flags;
                    if (true && (flags & MessagesController.DIALOG_FILTER_FLAG_EXCLUDE_MUTED) == 0) {
                ...
                while (cursor.next()) {
                    ...
                    for (String q : search) {
                        if (name.startsWith(q) || name.contains(" " + q) || tName != null && (tName.startsWith(q) || tName.contains(" " + q))) {
                            ...
                            found = 2;
                        } else if (NumberUtil.isInteger(q) && (NumberUtil.parseInt(q) == uid || q.length() > 3 && String.valueOf(uid).contains(q))) {
                            found = 3;
                        }
                        if (found != 0) {
                            NativeByteBuffer data = cursor.byteBufferValue(0);
            ...
            if (!chatsToLoad.isEmpty()) {
                ...
                while (cursor.next()) {
                    ...
                    for (String q : search) {
                        ...
                        if (name.startsWith(q) || name.contains(" " + q) || tName != null && (tName.startsWith(q) || tName.contains(" " + q))) {
                            found = 1;
                        } else if (q.matches("\\d+") && (Long.parseLong(q) == chatId || q.length() > 3 && String.valueOf(chatId).contains(q))) {
                            found = 2;
                        }
                        if (found > 0) {
                            NativeByteBuffer data = cursor.byteBufferValue(0);
                ...
                while (cursor.next()) {
                    ...
                    for (int a = 0; a < search.length; a++) {
                        ...
                        if (name.startsWith(q) || name.contains(" " + q) || tName != null && (tName.startsWith(q) || tName.contains(" " + q))) {
                            ...
                            found = 2;
                        } else if (NumberUtil.isInteger(q) && (NumberUtil.parseInt(q) == user_id || q.length() > 3 && String.valueOf(user_id).contains(q))) {
                            found = 3;
                        }
    ...
    private void saveStoryAlbumsCacheInternal(long dialogId, List<StoriesController.StoryAlbum> albums) {
        ...
        try {
            ...
            for (int i = 0; i < albums.size(); i++) {
                ...
                state.requery();
                state.bindLong(1, dialogId);
                state.bindInteger(2, (int) album.album_id); // Tony Chat: Stories removed - cast long to int
