...
public class ThemeColors {
    ...
    public static int[] createDefaultColors() {
        ...
        defaultColors[key_dialogTextLink] = 0xffC8A000;
        defaultColors[key_dialogLinkSelection] = 0x33F9E000;
        defaultColors[key_dialogTextBlue] = 0xffC8A000;
        defaultColors[key_dialogTextBlue2] = 0xffC8A000;
        defaultColors[key_dialogTextBlue4] = 0xffC8A000;
        defaultColors[key_dialogTextGray] = 0xffC8A000;
        ...
        defaultColors[key_dialogTopBackground] = 0xffF9E000;
        defaultColors[key_dialogInputField] = 0xffdbdbdb;
        defaultColors[key_dialogInputFieldActivated] = 0xffF9E000;
        defaultColors[key_dialogCheckboxSquareBackground] = 0xffF9E000;
        ...
        defaultColors[key_dialogRadioBackgroundChecked] = 0xffF9E000;
        defaultColors[key_dialogLineProgress] = 0xffF9E000;
        defaultColors[key_dialogLineProgressBackground] = 0xffdbdbdb;
        defaultColors[key_dialogButton] = 0xffC8A000;
        defaultColors[key_dialogButtonSelector] = 0x0f000000;
        defaultColors[key_dialogScrollGlow] = 0xfff5f6f7;
        defaultColors[key_dialogRoundCheckBox] = 0xffF9E000;
        ...
        defaultColors[key_dialogFloatingButton] = 0xffF9E000;
        ...
        defaultColors[key_windowBackgroundChecked] = 0xffF9E000;
        defaultColors[key_windowBackgroundCheckText] = 0xffffffff;
        defaultColors[key_progressCircle] = 0xffF9E000;
        defaultColors[key_windowBackgroundWhiteGrayIcon] = 0xff81868b;
        defaultColors[key_windowBackgroundWhiteBlueText] = 0xffC8A000;
        defaultColors[key_windowBackgroundWhiteBlueText2] = 0xffC8A000;
        defaultColors[key_windowBackgroundWhiteBlueText3] = 0xffC8A000;
        defaultColors[key_windowBackgroundWhiteBlueText4] = 0xffF9E000;
        defaultColors[key_windowBackgroundWhiteBlueText5] = 0xffC8A000;
        defaultColors[key_windowBackgroundWhiteBlueText6] = 0xffC8A000;
        defaultColors[key_windowBackgroundWhiteBlueText7] = 0xffC8A000;
        defaultColors[key_windowBackgroundWhiteBlueButton] = 0xffF9E000;
        defaultColors[key_windowBackgroundWhiteBlueIcon] = 0xffF9E000;
        ...
        defaultColors[key_windowBackgroundWhiteValueText] = 0xffC8A000;
        defaultColors[key_windowBackgroundWhiteLinkText] = 0xffC8A000;
        defaultColors[key_windowBackgroundWhiteLinkSelection] = 0x33F9E000;
        defaultColors[key_windowBackgroundWhiteBlueHeader] = 0xffC8A000;
        defaultColors[key_windowBackgroundWhiteInputField] = 0xffdbdbdb;
        defaultColors[key_windowBackgroundWhiteInputFieldActivated] = 0xffF9E000;
        defaultColors[key_switchTrack] = 0xffb0b5ba;
        defaultColors[key_switchTrackChecked] = 0xffF9E000;
        defaultColors[key_switchTrackBlue] = 0xff828e99;
        defaultColors[key_switchTrackBlueChecked] = 0xffC8A000;
        ...
        defaultColors[key_switch2TrackChecked] = 0xffF9E000;
        defaultColors[key_checkboxSquareBackground] = 0xffF9E000;
        ...
        defaultColors[key_radioBackgroundChecked] = 0xffF9E000;
        ...
        defaultColors[key_contextProgressInner1] = 0xffFFF4B3;
        defaultColors[key_contextProgressOuter1] = 0xffF9E000;
        defaultColors[key_contextProgressInner2] = 0xffFFF4B3;
        ...
        defaultColors[key_fastScrollActive] = 0xffF9E000;
        ...
        defaultColors[key_avatar_backgroundActionBarBlue] = 0xffC8A000;
        ...
        defaultColors[key_avatar_nameInMessageBlue] = 0xffC8A000;
        ...
        defaultColors[key_chats_archiveBackground] = 0xffF9E000;
        ...
        defaultColors[key_chats_nameMessage] = 0xffC8A000;
        ...
        defaultColors[key_chats_attachMessage] = 0xffC8A000;
        defaultColors[key_chats_actionMessage] = 0xffC8A000;
        ...
        defaultColors[key_chats_verifiedBackground] = 0xffF9E000;
        ...
        defaultColors[key_chats_menuItemCheck] = 0xffC8A000;
        ...
        defaultColors[key_chats_menuPhoneCats] = 0xffFFF4B3;
        defaultColors[key_chats_actionIcon] = 0xffffffff;
        defaultColors[key_chats_actionBackground] = 0xffF9E000;
        defaultColors[key_chats_actionPressedBackground] = 0xffE5CC00;
        defaultColors[key_chats_menuTopBackgroundCats] = 0xffC8A000;
        defaultColors[key_chats_archivePullDownBackground] = 0xffc6c9cc;
        defaultColors[key_chats_archivePullDownBackgroundActive] = 0xffF9E000;

        defaultColors[key_chat_attachCheckBoxCheck] = 0xffffffff;
        defaultColors[key_chat_attachCheckBoxBackground] = 0xffF9E000;
        defaultColors[key_chat_attachPhotoBackground] = 0x0c000000;
        defaultColors[key_chat_attachActiveTab] = 0xffF9E000;
        ...
        defaultColors[key_chat_attachGalleryBackground] = 0xffF9E000;
        defaultColors[key_chat_attachGalleryText] = 0xffC8A000;
        defaultColors[key_chat_attachAudioBackground] = 0xffeb6060;
        defaultColors[key_chat_attachAudioText] = 0xffde4747;
        defaultColors[key_chat_attachFileBackground] = 0xffF9E000;
        defaultColors[key_chat_attachFileText] = 0xffC8A000;
        ...
        defaultColors[key_chat_messageLinkIn] = 0xffC8A000;
        defaultColors[key_chat_messageLinkOut] = 0xffC8A000;
        ...
        defaultColors[key_chat_inInstant] = 0xffC8A000;
        defaultColors[key_chat_inInstantSelected] = 0xffC8A000;
        ...
        defaultColors[key_chat_inPreviewInstantText] = 0xffC8A000;
        ...
        defaultColors[key_chat_inForwardedNameText] = 0xffC8A000;
        ...
        defaultColors[key_chat_inReplyNameText] = 0xffC8A000;
        ...
        defaultColors[key_chat_inPreviewLine] = 0xffF9E000;
        defaultColors[key_chat_outPreviewLine] = 0xff88c97b;
        defaultColors[key_chat_inSiteNameText] = 0xffC8A000;
        defaultColors[key_chat_outSiteNameText] = 0xff55ab4f;
        defaultColors[key_chat_inContactNameText] = 0xffC8A000;
        ...
        defaultColors[key_chat_inAudioTitleText] = 0xffC8A000;
        ...
        defaultColors[key_chat_inFileNameText] = 0xffC8A000;
        ...
        defaultColors[key_chat_linkSelectBackground] = 0x33F9E000;
        defaultColors[key_chat_outLinkSelectBackground] = 0x33F9E000;
        ...
        defaultColors[key_chat_fieldOverlayText] = 0xffC8A000;
        ...
        defaultColors[key_chat_replyPanelName] = 0xffC8A000;
        ...
        defaultColors[key_chat_topPanelTitle] = 0xffC8A000;
        ...
        defaultColors[key_profile_creatorIcon] = 0xffC8A000;
        ...
        defaultColors[key_profile_tabSelectedText] = 0xffC8A000;
        ...
        defaultColors[key_groupcreate_cursor] = 0xffF9E000;
        ...
        defaultColors[key_picker_enabledButton] = 0xffC8A000;
        ...
        defaultColors[key_voipgroup_windowBackgroundWhiteInputFieldActivated] = 0xffF9E000;
        ...
        defaultColors[key_chat_inReactionButtonText] = 0xffC8A000;
